...
func (m *StoredGame) GetRead() string {
	if m != nil {
		return m.Read
	}
	return ""
...
var fileDescriptor_8439c9c90688ff75 = []byte{
	...
	0x80, 0x33, 0x94, 0xca, 0xb8, 0xb8, 0x82, 0xc1, 0xaa, 0xdd, 0x13, 0x73, 0x53, 0x85, 0x44, 0xb8,
	...
	0x2c, 0x50, 0x95, 0x20, 0x0e, 0x48, 0x65, 0x51, 0x6a, 0x62, 0x8a, 0x04, 0x2b, 0x44, 0x25, 0x88,
	...
	0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x60, 0x57, 0xeb, 0xc3, 0xfd, 0x55, 0x81,
	0x60, 0x96, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x7d, 0x67, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0x91, 0x3a, 0x97, 0x07, 0xfb, 0x00, 0x00, 0x00,
}
...
func (m *StoredGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Read) > 0 {
		i -= len(m.Read)
		copy(dAtA[i:], m.Read)
		i = encodeVarintStoredGame(dAtA, i, uint64(len(m.Read)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Black) > 0 {
